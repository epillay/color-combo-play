...
class Ellipse implements Drawable {
    ...
    Ellipse(float x, float y, float w, float h, boolean isFilled) {
        this.x = x;
        this.y = y;
        this.w = w;
        this.h = h;
    ...
    Ellipse(Point p, float w, float h, boolean isFilled) {
    ...
    // gets a random corner from the ellipse returned as a point
